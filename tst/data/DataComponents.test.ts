...
describe("FilterManager", () => {
    ...
    describe("Initialization", () => {
        it("should initialize with container element", () => {
            const input = containerElement.querySelector<HTMLInputElement>(
                "[data-ss-filter-input]",
            );
            if (input) {
                filterManager = new FilterManager(input);
    ...
    describe("Tag Filtering", () => {
        ...
        it("should filter by tag", async () => {
            if (
                filterManager &&
                typeof (filterManager as any).filterByTag === "function"
            ) {
        ...
        it("should support multiple tags", async () => {
            if (
                filterManager &&
                typeof (filterManager as any).filterByTags === "function"
            ) {
    ...
    describe("Callbacks", () => {
        it("should call onFilter callback", async () => {
            ...
            if (input) {
                filterManager = new FilterManager(input, { onFilter });
...
describe("RatingManager", () => {
    ...
    beforeEach(() => {
        ...
        `;
        ratingElement = document.getElementById(
            "rating-container",
        ) as HTMLElement;
    });
