...
describe("Tooltip", () => {
    ...
    beforeEach(() => {
        ...
        triggerElement = document.getElementById("tooltip-trigger") as HTMLElement
    })
    ...
    describe("Initialization", () => {
        ...
        it("should extract content from data attribute", () => {
            ...
            expect(triggerElement.getAttribute("data-ss-tooltip-content")).toBe(
    ...
    describe("Positioning", () => {
        ...
        positions.forEach((position) => {
            it(`should support ${position} position`, () => {
                ...
                expect(triggerElement.getAttribute("data-ss-tooltip-position") || position).toBeDefined()
            })
        })
