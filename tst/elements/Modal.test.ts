...
describe("Modal", () => {
    ...
    beforeEach(() => {
        ...
        triggerElement = document.getElementById("modal-trigger") as HTMLElement
    })
    ...
    describe("Trigger Elements", () => {
        ...
        it("should close modal when close button is clicked", async () => {
            ...
            const closeBtn = modalElement.querySelector("[data-ss-modal-close]")
            if (closeBtn) {
                click(closeBtn)
                await wait(350)
                expect(modal.opened).toBe(false)
    ...
    describe("Backdrop", () => {
        ...
        it("should not close on content click", async () => {
            ...
            const content = modalElement.querySelector("[data-ss-modal-content]")
            if (content) {
                click(content)
                await wait(50)
                expect(modal.opened).toBe(true)
