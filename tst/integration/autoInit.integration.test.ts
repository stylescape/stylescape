...
describe("Auto-Init Integration", () => {
    ...
    describe("MutationObserver Integration", () => {
        it("should initialize dynamically added elements", async () => {
            const { init, observe } = await import("../../src/ts/init/autoInit")
            await init()
            observe()
        ...
        it("should not re-initialize existing elements", async () => {
            ...
            const { init, getInstance } = await import("../../src/ts/init/autoInit")
            await init()
    ...
    describe("Instance Management", () => {
        ...
        it("should allow destroying component instances", async () => {
            ...
            const { init, destroy } = await import("../../src/ts/init/autoInit")
            await init()
    ...
    describe("Global API", () => {
        it("should expose Stylescape on window", async () => {
            const { initializeStylescape } = await import("../../src/ts/init/autoInit")
        ...
        it("should allow programmatic component registration", async () => {
            const { registerComponent, componentRegistry } = await import("../../src/ts/init/registry")
