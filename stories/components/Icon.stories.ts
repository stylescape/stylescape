// ==========================================================================
// Stylescape | Storybook — Icon
// ==========================================================================
// Auto-generated from src/jinja/31-modules/icon.html.jinja.
    ...
    render: () => html`
        <div style="display: flex; gap: 20px; flex-wrap: wrap">
            ...
            <svg
                ...
                viewBox="0 0 24 24"
                fill="none"
                stroke="var(--color_state_success)"
                stroke-width="2"
            >
                <circle cx="12" cy="12" r="10" />
                <path d="m9 12 2 2 4-4" />
            ...
            <svg
                ...
                viewBox="0 0 24 24"
                fill="none"
                stroke="var(--color_state_warning)"
                stroke-width="2"
            >
                <path
